...
public class AuthServerSecurityConfig {
  ...
  @Bean
  public FederatedIdentityConfigurer federatedIdentityConfigurer() {
    ...
    RegisteredClient oidcClient =
        RegisteredClient.withId(UUID.randomUUID().toString())
            ...
            .tokenSettings(TokenSettings.builder()
                .accessTokenTimeToLive(Duration.ofMinutes(30))  // 30 minutes
                .refreshTokenTimeToLive(Duration.ofHours(8))    // 8 hours

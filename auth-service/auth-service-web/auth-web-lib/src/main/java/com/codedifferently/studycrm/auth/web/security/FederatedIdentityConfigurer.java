...
public final class FederatedIdentityConfigurer
     ...
     *                                the login flow with an external IDP, defaults
     *                                to {@code
    ...
    /**
     * @param oauth2UserHandler The {@link Consumer} for performing JIT account
     *                          provisioning
    ...
    /**
     * @param oidcUserHandler The {@link Consumer} for performing JIT account
     *                        provisioning

...
public class OrganizationsController {
    ...
    public ResponseEntity<GetOrganizationsResponse> getAll() {
        return ResponseEntity
                .ok(new GetOrganizationsResponse(
                        StreamSupport.stream(organizationRepository.findAll().spliterator(), false)
                                .map(c -> new GetOrganizationResponse(c.getId(), c.getOrganizationName()))
    ...
    public ResponseEntity<GetOrganizationResponse> getOrganization(
        ...
        return organizationRepository
                ...
                .map(c -> new ResponseEntity<>(new GetOrganizationResponse(c.getId(), c.getOrganizationName()),
                        HttpStatus.OK))

    ...
    <div className="container mx-auto p-8">
      ...
      <div className="bg-gray-100 p-4 rounded-lg mb-6">
        ...
        <div className="space-y-2">
          ...
          <p>
            <strong>Organization IDs:</strong>{' '}
            {session?.user?.organizationIds?.join(', ') || 'N/A'}
          </p>
          <p>
          ...
          <p>
            <strong>Has ID Token:</strong> {session?.idToken ? 'Yes' : 'No'}
          </p>
          <p>
  ...
  return (
    <div className="bg-yellow-50 p-4 rounded-lg">
      ...
      <ol className="list-decimal list-inside space-y-2 text-sm">
        <li>
          Leave this page open for 25+ minutes to test automatic token refresh
        </li>
        <li>Check the browser console for token refresh logs</li>
        <li>
          Try making API calls after 25+ minutes to verify tokens are refreshed
        </li>
        <li>
          Wait 8+ hours to test refresh token expiration and forced
          re-authentication
        </li>
      </ol>
    </div>
